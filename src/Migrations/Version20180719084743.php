 ...
 */
final class Version20180719084743 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bordereau (id INT AUTO_INCREMENT NOT NULL, prefecture_id_id INT DEFAULT NULL, tribunal_id_id INT DEFAULT NULL, stage_id INT DEFAULT NULL, INDEX IDX_F7B4C561747B1928 (prefecture_id_id), INDEX IDX_F7B4C561D5BBB400 (tribunal_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE liaison_stagiaire_stage_dossier_cas_bordereau (id INT AUTO_INCREMENT NOT NULL, stagiaire_id_id INT DEFAULT NULL, stage_id_id INT DEFAULT NULL, suivi_dossier_id_id INT DEFAULT NULL, cas_stage_id_id INT DEFAULT NULL, bordereau_id_id INT DEFAULT NULL, INDEX IDX_CF1E2B422AA7DFFB (stagiaire_id_id), INDEX IDX_CF1E2B42FFE32C93 (stage_id_id), UNIQUE INDEX UNIQ_CF1E2B424EC5FD04 (suivi_dossier_id_id), UNIQUE INDEX UNIQ_CF1E2B4248F70A6A (cas_stage_id_id), INDEX IDX_CF1E2B4235BA7507 (bordereau_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tribunal (id INT AUTO_INCREMENT NOT NULL, nature_tribunal_id_id INT DEFAULT NULL, autorite_tribunal_id_id INT DEFAULT NULL, service_tribunal_id_id INT DEFAULT NULL, tribunal_nom VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, commune VARCHAR(255) DEFAULT NULL, INDEX IDX_DC8C3AAF2A34D77F (nature_tribunal_id_id), INDEX IDX_DC8C3AAFBEFB0DC0 (autorite_tribunal_id_id), INDEX IDX_DC8C3AAFD6DDE9B6 (service_tribunal_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE prix (id INT AUTO_INCREMENT NOT NULL, prix INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE stagiaire (id INT AUTO_INCREMENT NOT NULL, civilite_id_id INT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, nom_naissance VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, date_naissance DATE DEFAULT NULL, lieu_naissance VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, commune VARCHAR(255) DEFAULT NULL, pays VARCHAR(255) DEFAULT NULL, tel_portable VARCHAR(255) DEFAULT NULL, tel_fixe VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, carte_avantages_jeunes TINYINT(1) NOT NULL, partenaires TINYINT(1) NOT NULL, adherents TINYINT(1) NOT NULL, INDEX IDX_4F62F731C6BE736B (civilite_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE defraiement (id INT AUTO_INCREMENT NOT NULL, repas TINYINT(1) NOT NULL, km_ar INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE animateur (id INT AUTO_INCREMENT NOT NULL, civilite_id_id INT DEFAULT NULL, fonction_animateur_id_id INT DEFAULT NULL, statut_id_id INT DEFAULT NULL, forfait_animateur_id_id INT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, gta TINYINT(1) NOT NULL, raison_sociale VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, commune VARCHAR(255) DEFAULT NULL, region VARCHAR(255) DEFAULT NULL, tel_portable VARCHAR(255) DEFAULT NULL, tel_fixe VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, urssaf VARCHAR(255) DEFAULT NULL, siret VARCHAR(255) DEFAULT NULL, INDEX IDX_2064DB2CC6BE736B (civilite_id_id), INDEX IDX_2064DB2C5A467232 (fonction_animateur_id_id), INDEX IDX_2064DB2C4DB9F129 (statut_id_id), INDEX IDX_2064DB2CB364AC04 (forfait_animateur_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE animateur_stage (id INT AUTO_INCREMENT NOT NULL, animateur_id INT DEFAULT NULL, stage_id INT DEFAULT NULL, defraiement_id INT DEFAULT NULL, INDEX IDX_4A06D2447F05C301 (animateur_id), INDEX IDX_4A06D2442298D193 (stage_id), INDEX IDX_4A06D24489DE9505 (defraiement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE prefecture (id INT AUTO_INCREMENT NOT NULL, prefecture_nature_id_id INT DEFAULT NULL, autorite_prefecture_id_id INT DEFAULT NULL, service_prefecture_id_id INT DEFAULT NULL, prefecture_nom VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, commune VARCHAR(255) DEFAULT NULL, INDEX IDX_ABE6511AF0DA99CA (prefecture_nature_id_id), INDEX IDX_ABE6511AD3CAE0E (autorite_prefecture_id_id), INDEX IDX_ABE6511AD33E3E39 (service_prefecture_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE liaison_stagiaire_stage_dossier_cas_bordereau ADD CONSTRAINT FK_CF1E2B422AA7DFFB FOREIGN KEY (stagiaire_id_id) REFERENCES stagiaire (id)');
        ...
        $this->addSql('ALTER TABLE liaison_stagiaire_stage_dossier_cas_bordereau ADD CONSTRAINT FK_CF1E2B4235BA7507 FOREIGN KEY (bordereau_id_id) REFERENCES bordereau (id)');
        ...
        $this->addSql('ALTER TABLE animateur_stage ADD CONSTRAINT FK_4A06D2447F05C301 FOREIGN KEY (animateur_id) REFERENCES animateur (id)');
        $this->addSql('ALTER TABLE animateur_stage ADD CONSTRAINT FK_4A06D2442298D193 FOREIGN KEY (stage_id) REFERENCES stage (id)');
        $this->addSql('ALTER TABLE animateur_stage ADD CONSTRAINT FK_4A06D24489DE9505 FOREIGN KEY (defraiement_id) REFERENCES defraiement (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE liaison_stagiaire_stage_dossier_cas_bordereau DROP FOREIGN KEY FK_CF1E2B4235BA7507');
        ...
        $this->addSql('ALTER TABLE liaison_stagiaire_stage_dossier_cas_bordereau DROP FOREIGN KEY FK_CF1E2B422AA7DFFB');
        ...
        $this->addSql('ALTER TABLE animateur_stage DROP FOREIGN KEY FK_4A06D24489DE9505');
        ...
        $this->addSql('DROP TABLE defraiement');
