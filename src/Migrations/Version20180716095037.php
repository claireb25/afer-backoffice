 ...
 */
final class Version20180716095037 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prefecture ADD autorite_prefecture_id_id INT DEFAULT NULL, DROP autorite_id_id, CHANGE prefecture_nature_id_id prefecture_nature_id_id INT DEFAULT NULL, CHANGE prefecture_nom prefecture_nom VARCHAR(255) DEFAULT NULL, CHANGE adresse adresse VARCHAR(255) DEFAULT NULL, CHANGE code_postal code_postal VARCHAR(255) DEFAULT NULL, CHANGE commune commune VARCHAR(255) DEFAULT NULL, CHANGE prefecture_service prefecture_service VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE tribunal ADD autorite_tribunal_id_id INT DEFAULT NULL, DROP autorite_id_id, CHANGE tribunal_nature_id_id tribunal_nature_id_id INT DEFAULT NULL, CHANGE tribunal_nom tribunal_nom VARCHAR(255) DEFAULT NULL, CHANGE adresse adresse VARCHAR(255) DEFAULT NULL, CHANGE code_postal code_postal VARCHAR(255) DEFAULT NULL, CHANGE commune commune VARCHAR(255) DEFAULT NULL, CHANGE tribunal_service tribunal_service VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prefecture ADD autorite_id_id INT DEFAULT NULL, DROP autorite_prefecture_id_id, CHANGE prefecture_nature_id_id prefecture_nature_id_id INT DEFAULT NULL, CHANGE prefecture_nom prefecture_nom VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE adresse adresse VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE code_postal code_postal VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE commune commune VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE prefecture_service prefecture_service VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('ALTER TABLE tribunal ADD autorite_id_id INT DEFAULT NULL, DROP autorite_tribunal_id_id, CHANGE tribunal_nature_id_id tribunal_nature_id_id INT DEFAULT NULL, CHANGE tribunal_nom tribunal_nom VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE adresse adresse VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE code_postal code_postal VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE commune commune VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE tribunal_service tribunal_service VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
